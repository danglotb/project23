...
class CenterLayout extends RelativeLayout {
	...
	void update() {
		...
		this._model.getChild(0).setPosition(new utils.Coordinates2D((this._model.getSize().x-this._model.getChild(0).getSize().x)~/2, (this._model.getSize().y-this._model.getChild(0).getSize().y)~/2));
